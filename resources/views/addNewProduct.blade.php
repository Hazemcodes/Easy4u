			...
			<div class="flex-w flex-tr">
				<div class="size-220 bor10 p-lr-70 p-t-20 p-b-30 p-lr-15-lg w-full-md" style="margin-left: auto; margin-right: auto;">
					<form action="{{ route('addNewProduct') }}" method="POST" enctype="multipart/form-data">
						...
						<input class="stext-111 cl2 plh3 size-116 p-l-10 p-r-30" type="name" name="name" value="{{old('name')}}" placeholder="Product name">
						</div>
						<span class="text-danger">@error('name') {{$message}} @enderror</span>

						<label for="description">Product Description</label>
						<div class="bor8 m-b-2 how-pos4-parent">
							<textarea class="stext-111 cl2 plh3 size-116 p-l-10 p-r-30" name="description" value="{{old('description')}}" cols="30" rows="10"></textarea>
						</div>
						...
						<div class="m-t-10 m-b-25 how-pos4-parent">
							...
							<input style="float:left; width: 15%;" class="bor8" type="dimensions" name="dimensions" value="{{old('dimensions')}}">
							<span style="float:left; margin-right: 5%">	cm</span>
							
							<label style=" float:left;margin-right: 0.5%" for="weight">weight :</label>	
							<input style="float:left; width: 10%;" class="bor8" type="weight" name="weight" value="{{old('weight')}}">
							
							<br>
							<br>
							<label style=" float:left; margin-right: 0.5%" for="materials">Materials :</label>	
							<input style="float:left; width: 15%; margin-right: 12%" class="bor8" name="materials" value="{{old('materials')}}">
							
							<label for="price" style="float:left;margin-right: 0.5%">Price :</label>	
							<input style="float:left; width: 10%;" class="bor8" type="price" name="price" value="{{old('price')}}">
						...
						<div class="how-pos4-parent	m-t-50 m-b-15">
							<label for="category" style="text-align: right; float:left; margin-right:15px;">Choose the Category :</label>
						...
						<div class="m-t-10 m-b-10 how-pos4-parent">
							<span for="seller">Seller: {{$data->name}}</span>
						</div>
