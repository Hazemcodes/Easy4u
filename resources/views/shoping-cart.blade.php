							...
							<table class="table-shopping-cart">
								...
								@for ($i=0; $i < count($allproduct); $i++)									
									<tr class="table_row">
										...
										<td class="column-2">{{$allproduct[$i]->name}}</td>
										<td class="column-3">$ {{$allproduct[$i]->price}}</td>
										<td class="column-4">
										...
										<td class="column-5">$ {{$allproduct[$i]->price}}</td>
									</tr>
								@endfor 
							</table>
						</div>
					...
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="time" id="mySelect" onchange="myFunction()">
						...
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								<span class="mtext-110 cl2">
									{{-- adding Shipping for different Countries --}}
