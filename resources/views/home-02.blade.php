				...
				<div class="sidebar-gallery w-full p-tb-30">
					...
					<div class="flex-w flex-sb p-t-36 gallery-lb">
						...
						<div class="wrap-item-gallery m-b-10">
							...
							style="background-image: url({{asset('assets/images/gallery-02.jpg')}});"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href={{asset("images/gallery-03.jpg")}} data-lightbox="gallery" 
							style="background-image: url({{asset('assets/images/gallery-03.jpg')}});"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href={{asset("assets/images/gallery-04.jpg")}} data-lightbox="gallery" 
							style="background-image: url({{asset('assets/images/gallery-04.jpg')}});"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href={{asset("assets/images/gallery-05.jpg")}} data-lightbox="gallery" 
							style="background-image: url({{asset('assets/images/gallery-05.jpg')}});"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href={{asset("assets/images/gallery-06.jpg")}} data-lightbox="gallery" 
							style="background-image: url({{asset('assets/images/gallery-06.jpg')}});"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href={{asset("assets/images/gallery-07.jpg")}} data-lightbox="gallery" 
							style="background-image: url({{asset('assets/images/gallery-07.jpg')}});"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href={{asset("assets/images/gallery-08.jpg")}} data-lightbox="gallery" 
							style="background-image: url({{asset('assets/images/gallery-08.jpg')}});"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href={{asset("assets/images/gallery-09.jpg")}} data-lightbox="gallery" 
							style="background-image: url({{asset('assets/images/gallery-09.jpg')}});"></a>
						</div>
					</div>
				</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs1-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url({{asset('assets/images/slide-04.jpg')}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
