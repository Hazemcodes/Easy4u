		...
		<div class="container">
			...
			{{-- <div id="product" class="row isotope-grid"> --}}
					...
					{{-- 	@if ($products[$i]->exists())
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$categorytitle}}">
								<!-- Block2 -->
								<div class="block2">
									<div class="block2-pic hov-img0">
										<img src={{asset($products[$i]->photo)}} alt="IMG-PRODUCT">
									...
									<div class="block2-txt flex-w flex-t p-t-14">
										<div class="block2-txt-child1 flex-col-l ">
											...
											<span id="gettitle" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
												{{$products[$i]->name }}
											</span>
											@else 
											@endif
			...
			<!-- Show more -->
			{{-- <div id="moreProo" class="flex-c-m flex-w w-full p-t-45">
				{{-- <a  class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">Load More</a> --}}
				{{-- {{$products->links()}} --}}
			{{--<a wire:click="loadMore" class="btn flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04" >show more</a>
			</div> --}}
		</div>
	</section>
    <!-- Modal1 -->
