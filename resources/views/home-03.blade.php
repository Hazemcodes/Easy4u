...
@section('content')
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			<div class="slick1">
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-05.jpg))}};" data-thumb={{asset("assets/images/thumb-01.jpg")}} data-caption="Women’s Wear">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-06.jpg))}};" data-thumb={{asset("assets/images/thumb-02.jpg")}} data-caption="Men’s Wear">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-07.jpg))}};" data-thumb={{asset("assets/images/thumb-03.jpg")}} data-caption="Men’s Wear">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
