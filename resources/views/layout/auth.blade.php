...
<html lang="en">
    <head>
        ...
        <!--===============================================================================================-->	
        <link rel="icon" type="image/png" href="{{secure_asset('assets/images/icons/favicon.png')}}"/>
        <!--===============================================================================================-->
...
<body class="animsition">
	...
	<div style="margin-left: 45%; margin-right: 40% ; height:10% ; width: 15%;">
		<a href="index" class="logo">
			<img src={{secure_asset("assets/images/icons/logo-01.png")}} alt="IMG-LOGO">
		</a>
	</div>	
...
<!--===============================================================================================-->
	...
	<script src={{secure_asset("assets/js/map-custom.js")}}></script>
<!--===============================================================================================-->
